...
def twitterdownloader(username, directory): 
...
#getting the tweet from the user, number of tweets are 200
	...
	#	directory = raw_input('Enter the directory for the saved photos (eg: /Users/Hayato/Desktop/Media/): ')
...
#	    font_type = ImageFont.truetype('arial.ttf', 35)                     # if you want to change the font
	    ...
	    draw.text(xy=(0, 0), text = y, fill=(255, 69, 0))
...
def main():
	twitterdownloader("hayatopia", "/Users/jleong/Desktop/EC500/HayatoCode/EC500_C1-master/API/")
